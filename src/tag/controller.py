...
def build_parser() -> argparse.ArgumentParser:
    ...
    # ── PRD-065/068: memory+ extensions (new subcommands added to existing mem) ─
    # Note: `mem` parser already exists (PRD-025). We add new subcommands to it
    # via a dedicated handler that shares the dest="mem_subcommand" dispatch key.
